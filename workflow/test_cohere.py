from cohere_calls import invoke_cohere
import pytest

def test_invoke_cohere_happy_path():
    calls = []
    ...
    result = invoke_cohere("hello world", llm_fn=fake_llm)
...
def test_pipeline_data_flow():
    ...
    result = invoke_cohere("test", llm_fn=fake_llm)
