from anthropic_calls import invoke_claude_4_5
import pytest

def test_invoke_claude_4_5_happy_path():
    calls = []
    ...
    result = invoke_claude_4_5("hello world", llm_fn=fake_llm)
...
def test_pipeline_data_flow():
    ...
    result = invoke_claude_4_5("test", llm_fn=fake_llm)
